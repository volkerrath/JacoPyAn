...
However, it uses transformations of parameters and data given by ${\mathbf{\tilde{p}}}={\mathbf{C}_\mathbf{m}^{-1/2}} ({\mathbf{p}} - {\mathbf{p}_a})$ and ${\mathbf{\tilde{d}}}={\mathbf{C}_\mathbf{d}^{-1/2}}{\mathbf{d}}$ .
