...
However, it uses a transformation of data and parameters, given by ${\mathbf{\tilde{p}}}= {\mathbf{C}_\mathbf{m}^{-1/2}} ({\mathbf{p}} - {\mathbf{p}_a})$

_= \mathbf{C}_\mathbf{m}^{-1/2}$ and
