...
$$ 
  {\mathbf{\tilde g}}({\mathbf{\tilde p}}) = {\mathbf{C}}_{\mathbf{d}}^{ - 1/2}{\mathbf{g}}\left( {{\mathbf{C}}_{\mathbf{m}}^{1/2}{\mathbf{\tilde p}}} \right)         {\mathbf{\tilde J}} = {\mathbf{C}}_{\mathbf{d}}^{ - 1/2}{\mathbf{JC}}_{\mathbf{m}}^{1/2} \hfill $$
